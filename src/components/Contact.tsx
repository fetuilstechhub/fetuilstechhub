        ...
        <div className='max-w-6xl mx-auto bg-white rounded-[2.5rem] shadow-[0_20px_60px_-15px_rgba(11,31,63,0.08)] overflow-hidden flex flex-col lg:flex-row reveal border border-gray-100'>
          ...
          <div className='w-full lg:w-5/12 bg-[#0B1F3F] p-10 md:p-14 text-white relative overflow-hidden flex flex-col justify-between'>
            ...
            <div className='relative z-10'>
              <span className='text-primary tracking-widest uppercase text-sm font-bold mb-4 block'>
                Get In Touch
              </span>
              ...
              <p className='text-gray-300 text-lg mb-12 font-light leading-relaxed'>
                Have questions about our facilities, training programs, or how
                to become a member? Reach out and we'll get back to you.
              </p>
          ...
          <div className='w-full lg:w-7/12 p-10 md:p-14 bg-white relative'>
            <h3 className='text-2xl md:text-3xl font-extrabold text-[#0B1F3F] mb-8 tracking-tight'>
              Send us a message
            </h3>
            ...
            <form onSubmit={handleSubmit} className='space-y-8'>
              <div className='grid sm:grid-cols-2 gap-8 lg:gap-10'>
                <div className='group'>
                  <label className='text-xs font-bold text-gray-400 uppercase tracking-widest mb-1 block group-focus-within:text-primary transition-colors'>
                    First Name
                  </label>
                  <Input
                    placeholder='John'
              ...
              <div className='pt-4'>
                <Button
                  type='submit'
                  className='w-full sm:w-auto font-bold px-10 py-6 text-base rounded-full shadow-xl shadow-primary/20 hover:shadow-primary/40 group transition-all duration-300'
                >
                  Send Message
