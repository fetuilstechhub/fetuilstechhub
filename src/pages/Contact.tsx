  ...
  const faqs = [
    {
      ...
      answer: "Visit our hub during office hours with your student ID to register. Membership is free for all FET students."
    },
    {
      question: "What are the operating hours?",
      answer: "The hub is open 24/7 for registered members. Admin office hours are Mon-Fri, 8AM-5PM."
    },
    {
      question: "Are the training programs free?",
      answer: "Most basic programs are free for registered members. Advanced programs may have nominal fees."
    },
    {
      question: "Can non-FET students use the facilities?",
      answer: "Yes! All UNILORIN students are welcome, though FET students have priority access."
    }
  ];
        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-4xl">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl">
              Have questions about our facilities, training programs, or membership? 
              ...
              <div className="space-y-6 mb-12">
                ...
                <div className="flex items-start gap-4 p-6 rounded-2xl bg-card border border-border">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">support@fetuilstechhub.ng</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-6 rounded-2xl bg-card border border-border">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Hub Access: 24/7 (Members Only)<br />
            ...
            <div className="bg-card border border-border rounded-2xl p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <Input type="email" placeholder="john@student.unilorin.edu.ng" className="bg-background" />
                </div>
